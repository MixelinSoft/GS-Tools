...
//Просчитываем объём
fullCapacity = (((+higCapacity - +lowCapacity) / 10 * +meterTail) + +lowCapacity + +tubeCapacity);

//Выводим результат
document.write (fullCapacity);